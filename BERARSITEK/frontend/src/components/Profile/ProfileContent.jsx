        ...
        <>
          <div className="flex justify-center w-full">
            <div className="relative">
              <img src={`${backend_url}${user?.avatar}`} className="w-[150px] h-[150px] rounded-full object-cover border-[3px] border-[#0B3F9C]" alt="" />
              <div className="w-[30px] h-[30px] bg-[#C8E6F1] border border-[#0B3F9C] rounded-full flex items-center justify-center cursor-pointer absolute bottom-[5px] right-[5px]">
          ...
          <div className="w-full px-5">
            <form onSubmit={handleSubmit} aria-required={true}>
              ...
              <input className={`bg-[#0B3F9C] w-[250px] h-[40px] text-center text-[white] rounded-[3px] mt-8 cursor-pointer font-semibold`} required value="Update" type="submit" />
            </form>
          </div>
        </>
      )}
      ...
      <div className="w-full">
        <form aria-required onSubmit={passwordChangeHandler} className="flex flex-col items-center">
          ...
          <div className=" w-[100%] 800px:w-[50%] mt-2">
            ...
            <input className={`bg-[#0B3F9C] w-[95%] h-[40px] text-center text-[white] rounded-[3px] mt-8 cursor-pointer font-semibold`} required value="Update" type="submit" />
          </div>
        </form>
      </div>
    </div>
  ...
  return (
    <div className="w-full px-5">
            ...
            <div className="w-full">
              <form aria-required onSubmit={handleSubmit} className="w-full">
                <div className="w-full block p-4">
                  ...
                  <div className="w-full pb-2">
                    <label className="block pb-2 font-semibold">Choose your City</label>
                  ...
                  <div className="w-full pb-2 ">
                    <input type="submit" style={{ color: "white" }} className={`${styles.input} mt-5 cursor-pointer bg-[#0B3F9C] font-semibold`} required readOnly />
                  </div>
                </div>
              </form>
            </div>
      ...
      <div className="flex w-full items-center justify-between">
        <h1 className="text-[25px] font-[600] text-[#000000ba] pb-2">Saved Addresses</h1>
        <div className={`${styles.button} !rounded-md`} style={{ backgroundColor: "#0B3F9C" }} onClick={() => setOpen(true)}>
          <span className="text-[white] font-semibold">Add New</span>
        </div>
      </div>
      <br />
      {user &&
        user.addresses.map((item, index) => (
          <div className="w-full bg-white h-min 800px:h-[70px] rounded-[4px] flex items-center px-3 shadow justify-between pr-10 mb-5" key={index}>
            ...
            <div className="min-w-[10%] flex items-center justify-between pl-8">
              <AiOutlineDelete size={25} className="cursor-pointer" onClick={() => handleDelete(item)} style={{ color: "#0B3F9C" }} />
            </div>
          </div>
        ))}
