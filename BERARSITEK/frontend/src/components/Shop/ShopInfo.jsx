        ...
        <div>
          ...
          {isOwner && (
            <div className="py-3 px-4">
              <Link to="/settings">
                <div className={`${styles.button} !w-full !h-[42px] !rounded-[5px] bg-[#0B3F9C] font-semibold`} style={{ backgroundColor: "#0B3F9C" }}>
                  <span className="text-white">Edit Shop</span>
                </div>
              </Link>
              <div className={`${styles.button} !w-full !h-[42px] !rounded-[5px] bg-[#0B3F9C] font-semibold`} style={{ backgroundColor: "#0B3F9C" }} onClick={logoutHandler}>
